        ...
        _createClass(FormControl, [{
          ...
          value: function componentWillReceiveProps(nextProps) {
            ...
            _asyncToGenerator(regeneratorRuntime.mark(function _callee() {
              var _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, name, newValue;
                ...
                while (1) {
                  switch (_context.prev = _context.next) {
                    ...
                    case 5:
                      ...
                      _this2.assembleFieldChange(name, newValue);
                      _context.next = 13;
                      return _this2.assembleFieldValidate(name, newValue);
