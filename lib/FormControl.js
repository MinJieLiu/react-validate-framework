    ...
    return (
      ...
      _temp = _class = function (_Component) {
        ...
        function FormControl(props) {
          ...
          // 初始化验证组件并自定义验证方法
          _this.validator = new _validateFrameworkUtils2.default().addMethods(FormComponent.validator);
          return _this;
        }
        ...
        _createClass(FormControl, [{
          ...
          value: function validateByNames() {
            ...
            names.forEach(function (name) {
              var result = _this2.validateField(name, fields[name].value);
              // 排除 未验证 和 验证成功
              if (result === false) {
                isValid = false;
              }
        ...
        this.handleValidateByNames = function () {
          var result = _this3.validateByNames.apply(_this3, arguments);
          var fields = _this3.state.fields;
          // 更新
        ...
        this.handleValidate = function () {
          // 验证
          var isAllValid = _this3.validateAllFields();
          var fields = _this3.state.fields;
          // 更新
