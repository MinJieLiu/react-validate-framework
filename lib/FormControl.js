    ...
    return (
      ...
      _temp = _class = function (_Component) {
        ...
        function FormControl(props) {
          ...
          _this.classNames = props.classNames;
          ...
          Object.keys(values).forEach(function (name) {
            fields[name] = {
              className: _this.classNames.static,
              value: values[name]
            };
          });
          ...
          value: function componentWillReceiveProps(nextProps) {
            ...
            Object.keys(values).forEach(function (name) {
              ...
              if (fields[name]) {
                ...
                // Add a new field
                fields[name] = {
                  className: _this2.classNames.static,
                  value: newValue
                };
              }
            });
        ...
        this.initValues = function (values) {
          ...
          Object.keys(values).forEach(function (name) {
            fields[name] = {
              className: _this4.classNames.static,
              value: values[name]
            };
          });
        };
        ...
        this.initClassNames = function (classNames) {
          _extends(_this4.classNames, classNames);
        };
