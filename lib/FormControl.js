    ...
    return (
      ...
      _temp = _class = function (_Component) {
        ...
        _createClass(FormControl, [{
           ...
           * @param value
           */
          value: function delayValidateField(name, value) {
        ...
        initField: _react.PropTypes.func.isRequired,
        ...
        this.assembleFieldChange = function (name, value) {
          _extends(_this3.state.fields[name], {
            value: value
          });
          return _this3;
        };
        ...
        this.assembleFieldValidate = function (name, value) {
          ...
          var schema = _this3.schemas[name] && _extends(_this3.schemas[name], { value: value });
        ...
        this.addSchemas = function (schema) {
          _extends(_this3.schemas, schema);
          return _this3;
        };
